...
namespace MassTransit.Courier.MassTransitIntegration
{
        ...
        where TArguments : class
    {
        ...
        {
            Execution<TArguments> execution = new HostExecution<TArguments>(new MassTransitMessagingAdaptor(context), new SanitizedRoutingSlip(context), _compensateAddress, NewId.NextGuid());
